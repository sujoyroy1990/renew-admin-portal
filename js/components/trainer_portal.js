                    ...
                    <div class="bg-black/30 border border-gray-800/60 p-4 rounded-xl">
                        ...
                        <div class="space-y-3">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-800/40 pb-2">
                                <span class="text-gray-300 text-[11px] max-w-md">1. Has your doctor ever said you have a heart condition and recommended only medically supervised physical activity?</span>
