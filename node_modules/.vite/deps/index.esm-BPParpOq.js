...
var FirebaseServerAppImpl = class extends FirebaseAppImpl$1 {
	...
	*/
	checkDestroyed() {
		if (this.isDeleted) throw ERROR_FACTORY$1.create("server-app-deleted");
	}
};
/**
* @license
...
function initializeServerApp(_options, _serverAppConfig = {}) {
	if (isBrowser() && !isWebWorker()) throw ERROR_FACTORY$1.create("invalid-server-app-environment");
	let firebaseOptions;
	...
	if (!firebaseOptions) throw ERROR_FACTORY$1.create("no-options");
	const nameObj = {
		...serverAppSettings,
		...firebaseOptions
	};
	...
	if (serverAppSettings.releaseOnDeref !== void 0) {
		if (typeof FinalizationRegistry === "undefined") throw ERROR_FACTORY$1.create("finalization-registry-not-supported", {});
	}
...
function onLog(logCallback, options) {
	if (logCallback !== null && typeof logCallback !== "function") throw ERROR_FACTORY$1.create("invalid-log-argument");
...
//#endregion
//#region node_modules/@firebase/app-compat/dist/esm/index.esm.js
/**
* @license
* Copyright 2020 Google LLC
*
...
var FirebaseAppImpl = class {
	...
	*/
	_getService(name, instanceIdentifier = DEFAULT_ENTRY_NAME) {
		...
		if (!provider.isInitialized() && provider.getComponent()?.instantiationMode === "EXPLICIT") provider.initialize();
...
* limitations under the License.
*/
var ERROR_FACTORY = new ErrorFactory("app-compat", "Firebase", {
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
	...
	*/
	function app(name) {
		name = name || "[DEFAULT]";
		if (!contains(apps, name)) throw ERROR_FACTORY.create("no-app", { appName: name });
		return apps[name];
	}
	...
	*/
	function initializeAppCompat(options, rawConfig = {}) {
		...
		if (contains(apps, app.name)) return apps[app.name];
	...
	function registerComponentCompat(component) {
		...
		if (_registerComponent(component) && component.type === "PUBLIC") {
			const serviceNamespace = (appArg = app()) => {
				if (typeof appArg[componentNameWithoutCompat] !== "function") throw ERROR_FACTORY.create("invalid-app-argument", { appName: componentName });
				return appArg[componentNameWithoutCompat]();
			};
			if (component.serviceProps !== void 0) deepExtend(serviceNamespace, component.serviceProps);
...
//#endregion
export { isSafari as A, isCloudflareWorker as C, isMobileCordova as D, isIndexedDBAvailable as E, pingServer as M, querystring as N, isNode as O, querystringDecode as P, isCloudWorkstation as S, isIE as T, getExperimentalSetting as _, registerVersion as a, getUA as b, Component as c, FirebaseError as d, base64Decode as f, extractQuerystring as g, deepEqual as h, _registerComponent as i, isSafariOrWebkit as j, isReactNative as k, Deferred as l, createSubscribe as m, SDK_VERSION as n, LogLevel as o, createMockUserToken as p, _isFirebaseServerApp as r, Logger as s, firebase as t, ErrorFactory as u, getGlobal as v, isEmpty as w, isBrowserExtension as x, getModularInstance as y };
